...
public class CommonData {
	...
	//拿数据的消息队列名称(正式)
	public static final String TOPIC = "ocrtopic";
//	public static final String TOPIC = "testocrtopic";
	//消息队列对应的根路径
	public static final String ZOOKEEPER_ROOT = "";
	//web消息队列(正式)
	public static final String STORM = "xl_press_storm_formal";//TODO 正式

	//web消息队列(测试)
//	public static final String STORM = "xl_press_storm_test";//TODO 测试
