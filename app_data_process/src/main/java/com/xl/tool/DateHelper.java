...
public class DateHelper {
	 ...
	 * @Author: lww
	 * @Description:
	 * @Date: 15:19 2018/3/22
	 * @param data
	 */
	public static String formatDataSpicel(String data){

		if("".equals(data)){
			return DateHelper.getNowDate(DateHelper.FMT_DATE_DATETIME);
		}
		...
		if(datas.length>1){
			if(datas[0].length()==10){
				...
				}else if(datas[1].length()==5){
					return datas[0]+" "+datas[1]+":00";
				}else if(datas[1].length()==2){
					return datas[0]+" "+datas[1]+":00:00";
				}else{
					return datas[0]+" "+"00:00:00";
				}
			}else if(datas[0].length()==5){
				if(datas[1].length()==8){
					return DateHelper.getNowDate(DateHelper.FMT_DATE_YYYY)+"-"+datas[0]+" "+datas[1];
				}else if(datas[1].length()==5){
					return DateHelper.getNowDate(DateHelper.FMT_DATE_YYYY)+"-"+datas[0]+" "+datas[1]+":00";
				}else if(datas[1].length()==2){
					return DateHelper.getNowDate(DateHelper.FMT_DATE_YYYY)+"-"+datas[0]+" "+datas[1]+":00:00";
				}else{
					return DateHelper.getNowDate(DateHelper.FMT_DATE_YYYY)+"-"+datas[0]+" "+"00:00:00";
				}
			}else{
				return DateHelper.getNowDate(DateHelper.FMT_DATE_DATETIME);
			}
	...
	public static final String FMT_DATE_DATETIME5 = "yyyy/MM/dd HH:mm:ss";
