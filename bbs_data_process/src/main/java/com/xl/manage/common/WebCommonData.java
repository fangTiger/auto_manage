...
public class WebCommonData {
	...
	//拿数据的消息队列名称
	public static final String WEB_TOPIC = "bbstopic";
	//消息队列对应的根路径
	public static final String WEB_ZOOKEEPER_ROOT = "";
	//web消息队列(正式)
	public static final String WEB_STORM = "xl_bbs_storm_foraml";//TODO 正式
	//web消息队列(测试)
//	public static final String WEB_STORM = "xl_bbs_storm_test_bbs";//TODO 测试

	//日志输出信息开头
	public static final String LOG_OUT_INFO = "bbs";
...
//	private static final String DATA_PROCESS_URL = "http://192.168.10.55:8087";//TODO 测试
	...
	//全部数据入任务code
	public static final String WEB_INSERT_ALLDATA_CODE = "bbsInsertAllData";
