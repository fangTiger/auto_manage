...
public class WebCommonData {
	...
	//拿数据的消息队列名称(正式)
	public static final String WEB_TOPIC = "epapertopic";
	//消息队列对应的根路径
	public static final String WEB_ZOOKEEPER_ROOT = "";
	//web消息队列(正式)
	public static final String WEB_STORM = "xl_epaper_storm_foraml";//TODO 正式
	//web消息队列(测试)
//	public static final String WEB_STORM = "xl_epaper_storm_test";//TODO 测试

	//日志输出信息开头
	public static final String LOG_OUT_INFO = "epaper";
