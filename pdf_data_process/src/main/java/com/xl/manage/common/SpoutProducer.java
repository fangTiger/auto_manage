...
public class SpoutProducer {
	...
	public static SpoutConfig getSpout(BrokerHosts broker,String stormId){
		...
		SpoutConfig spoutConf = new SpoutConfig(broker, CommonData.TOPIC, CommonData.ZOOKEEPER_ROOT,
				stormId);
		...
		spoutConf.zkRoot = CommonData.ZOOKEEPER_ROOT;
		spoutConf.id = stormId;
