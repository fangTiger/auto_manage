...
public class WebCommonData {
	...
	//拿数据的消息队列名称
	public static final String WEB_TOPIC = "webtopic";
	//消息队列对应的根路径
	public static final String WEB_ZOOKEEPER_ROOT = "";
	//web消息队列(正式) //TODO 正式
//	public static final String WEB_STORM = "xl_web_storm_formal";

	//web消息队列(测试) //TODO 测试
	public static final String WEB_STORM = "xl_web_storm_formal_test";

//	public static final String WEB_STORM = "xl_lh_web_storm";

	//日志输出信息开头
	public static final String LOG_OUT_INFO = "web";
...
//	private static final String DATA_PROCESS_URL = "http://192.168.10.55:8083";//TODO 正式
	...
	//入排重DB
	public static final String INSERT_DB_URL = DATA_PROCESS_URL + "/classifier/insertDB";

	public static final String GET_DB_DATA_URL = DATA_PROCESS_URL + "/classifier/getDataByDB";
	...
	//全部数据入任务code
	public static final String WEB_INSERT_ALLDATA_CODE = "webInsertAllData";

	//全部数据入任务code
	public static final String BBS_INSERT_ALLDATA_CODE = "bbsInsertAllData";
