...
//拓扑名称
    ...
    public static void main(String[] args) {
        ...
        SplitSentenceBolt1 splitSentenceBolt1 = new SplitSentenceBolt1();
...
*/
        ...
        //配置第二个组件splitSentenceBolt,上游为sentenceSpout,tuple分组方式为随机分组shuffleGrouping
           ...
           //配置第二个组件测试组件（测试spout是否可以）
           topologyBuilder.setBolt("testbolt", splitSentenceBolt1).shuffleGrouping(SENTENCE_SPOUT_ID);
