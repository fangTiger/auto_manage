...
public class LogCacheBean {
    ...
    private Integer objectCount;//操作对象数量（针对数据，增删改）--其他项目记录日志时此值可为空
//    private String dataId;//唯一aid
    private String dataContent;//数据内容 --其他项目记录日志时此值可为空
    ...
    private Object _dataContent;//操作内容对象,用于objectCount，dataContent字段值的计算
    ...
    public Object get_dataContent() {
        return _dataContent;
    }

    public void set_dataContent(Object _dataContent) {
        this._dataContent = _dataContent;
    }
