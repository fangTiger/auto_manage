...
public class ArticleBean {
	...
	@JSONField(serialize=false)
	private String _content;//原正文
	@JSONField(serialize = false)
	private Double _size;
	@JSONField(serialize = false)
	private String _pdfPath;//PDF路径
	@JSONField(serialize = false)
	private String _articleThumbName;//缩略图
	@JSONField(serialize=false)
	...
	public String get_pdfPath() {
		return _pdfPath;
	}

	public void set_pdfPath(String _pdfPath) {
		this._pdfPath = _pdfPath;
	}

	public String get_articleThumbName() {
		return _articleThumbName;
	}

	public void set_articleThumbName(String _articleThumbName) {
		this._articleThumbName = _articleThumbName;
	}
