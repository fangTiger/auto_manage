...
import com.xl.manage.service.AutoEveSourceService;
 ...
 * @Date:11:24 2017/9/8
 */
public class AutoEveSourceBolt  extends BaseRichBolt {

	private OutputCollector outputCollector;
	private static final Logger log = LoggerFactory.getLogger(AutoEveSourceBolt.class);
	...
	public void execute(Tuple tuple) {
		...
		AutoEveSourceService service = new AutoEveSourceService();
		...
		try{
			...
			if(bean!=null){
				...
				LogHelper.info("-----------------------活动获取信息源规则失败！AutoEveSourceBolt.execute ArticleBean["+ JSONObject.toJSONString(bean)+"]--------------------------------------");
			}
		}catch (Exception e){
			outputCollector.fail(tuple);
			LogHelper.error("----------------------活动获取信息源规则出现异常！AutoEveSourceBolt.execute; ArticleBean["+ JSONObject.toJSONString(bean)+"]--------------------------",e);
		}
	}
