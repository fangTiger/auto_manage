...
public class ArticleBean {
	...
	private List<EventRuleBean> _eventSourceList;//信息源规则
	private List<EventRuleBean> _eventContentList;//内容规则
	private List<SubjectRuleBean> _subjectSourceList;//信息源规则
	private List<SubjectRuleBean> _subjectContentList;//内容规则
	...
	public List<EventRuleBean> get_eventSourceList() {
		return _eventSourceList;
	}

	public void set_eventSourceList(List<EventRuleBean> _eventSourceList) {
		this._eventSourceList = _eventSourceList;
	}

	public List<EventRuleBean> get_eventContentList() {
		return _eventContentList;
	}

	public void set_eventContentList(List<EventRuleBean> _eventContentList) {
		this._eventContentList = _eventContentList;
	}

	public List<SubjectRuleBean> get_subjectSourceList() {
		return _subjectSourceList;
	}

	public void set_subjectSourceList(List<SubjectRuleBean> _subjectSourceList) {
		this._subjectSourceList = _subjectSourceList;
	}

	public List<SubjectRuleBean> get_subjectContentList() {
		return _subjectContentList;
	}

	public void set_subjectContentList(List<SubjectRuleBean> _subjectContentList) {
		this._subjectContentList = _subjectContentList;
	}
}
